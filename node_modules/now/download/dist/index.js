...
var Headers = __webpack_require__(115);
...
var convert = __webpack_require__(343).convert;
var bodyStream = __webpack_require__(70);
var PassThrough = __webpack_require__(688).PassThrough;
var FetchError = __webpack_require__(661);
...
const hasFlag = __webpack_require__(860);
...
var Uni = __webpack_require__(711)
...
var data = __webpack_require__(347);
...
var fixer = __webpack_require__(596)
normalize.fixer = fixer

var makeWarning = __webpack_require__(735)
...
var errorEx = __webpack_require__(202);
var fallback = __webpack_require__(114);
...
var Body = __webpack_require__(59);
var Response = __webpack_require__(268);
var Headers = __webpack_require__(115);
...
var isArrayish = __webpack_require__(753);
...
const pify = __webpack_require__(285);
...
const stripBom = __webpack_require__(439);
const parseJson = __webpack_require__(163);
const pify = __webpack_require__(285);
...
var chalk = __webpack_require__(936);
...
async function main() {
  ...
  if (platform === 'win32') {
    try {
      ...
      let npmCmdFile = external_path_default.a.join(globalPath, 'now.cmd');
      if (!external_fs_default.a.existsSync(npmCmdFile)) {
        npmCmdFile = external_path_default.a.join(process.env.APPDATA, 'npm/now.cmd');
      }
...
var COLON = isWindows ? ';' : ':'
var isexe = __webpack_require__(13)
...
var scan = __webpack_require__(946)
...
var fs = __webpack_require__(66);
var path = __webpack_require__(589);
var caller = __webpack_require__(68);
var nodeModulesPaths = __webpack_require__(807);
var normalizeOptions = __webpack_require__(764);
...
const path = __webpack_require__(589);
const loadJsonFile = __webpack_require__(332);
const pathType = __webpack_require__(250);
...
var core = __webpack_require__(144);
var async = __webpack_require__(572);
async.core = core;
async.isCore = function isCore(x) { return core[x]; };
async.sync = __webpack_require__(377);
...
var validateLicense = __webpack_require__(889);
var hostedGitInfo = __webpack_require__(723)
var isBuiltinModule = __webpack_require__(564).isCore
var depTypes = ["dependencies","devDependencies","optionalDependencies"]
var extractDescription = __webpack_require__(551)
...
var url = __webpack_require__(77)
var gitHosts = __webpack_require__(62)
var GitHost = module.exports = __webpack_require__(908)
...
module.exports = global.Promise || __webpack_require__(999);
...
module.exports = __webpack_require__(285)(__webpack_require__(352), __webpack_require__(744));
...
module.exports = {"name":"now","version":"15.0.3","preferGlobal":true,"license":"Apache-2.0","description":"The command-line interface for Now","repository":"zeit/now-cli","scripts":{"test":"yarn test-lint","test-unit":"nyc ava test/*unit.js --fail-fast","test-integration":"ava test/integration.js --serial --fail-fast","test-lint":"eslint .","prepublishOnly":"yarn build-download && cp download/default.js download/dist/now","coverage":"nyc report --reporter=text-lcov > coverage.lcov && codecov","postinstall":"node download/install.js","gzip":"ls packed/now* | xargs gzip","bundle":"pkg bin/now.js -c package.json -o packed/now --options no-warnings","pack":"rm -rf packed && yarn build && yarn bundle","build-download":"ncc build ./download/src --out ./download/dist","link":"yarn run build-dev && cd link && npm link","build":"./build.sh","build-dev":"DEV=1 ./build.sh","format-modified":"prettier --parser typescript --write --single-quote `git diff --name-only | grep -e \".*\\.ts$\" -e \".*\\.js$\" | xargs echo`"},"nyc":{"include":["src/**"],"extension":[".js",".ts"],"require":["ts-node/register"],"reporter":["text","html"],"sourceMap":true,"instrument":true,"all":true},"git":{"pre-commit":["test-lint","format-modified"]},"bin":{"now":"download/dist/now"},"files":["download/dist","download/install.js"],"pkg":{"scripts":["dist/*.js"],"assets":["dist/runtimes"],"targets":["node10-alpine-x64","node10-linux-x64","node10-macos-x64","node10-win-x64"]},"eslintConfig":{"extends":["airbnb","prettier"],"parser":"@typescript-eslint/parser","plugins":["typescript"],"settings":{"import/resolver":{"typescript":{}}},"rules":{"camelcase":0,"class-methods-use-this":0,"consistent-return":0,"func-names":0,"global-require":0,"guard-for-in":0,"import/no-duplicates":0,"import/no-dynamic-require":0,"import/no-extraneous-dependencies":0,"import/prefer-default-export":0,"lines-between-class-members":0,"no-await-in-loop":0,"no-bitwise":0,"no-console":0,"no-continue":0,"no-control-regex":0,"no-empty":0,"no-loop-func":0,"no-nested-ternary":0,"no-param-reassign":0,"no-plusplus":0,"no-restricted-globals":0,"no-restricted-syntax":0,"no-shadow":0,"no-underscore-dangle":0,"no-use-before-define":0,"prefer-const":0,"prefer-destructuring":0,"typescript/no-unused-vars":"error"}},"eslintIgnore":["@types","download","dist","test/fixtures","bin","link"],"ava":{"compileEnhancements":false,"extensions":["ts"],"require":["ts-node/register/transpile-only","esm"]},"devDependencies":{"@now/build-utils":"0.4.40","@sentry/node":"4.5.3","@types/ansi-escapes":"3.0.0","@types/ansi-regex":"4.0.0","@types/async-retry":"1.2.1","@types/bytes":"3.0.0","@types/debug":"0.0.31","@types/dotenv":"6.1.1","@types/execa":"0.9.0","@types/fs-extra":"5.0.5","@types/glob":"7.1.1","@types/http-proxy":"1.16.2","@types/load-json-file":"2.0.7","@types/micro":"7.3.3","@types/mime-types":"2.1.0","@types/minimatch":"3.0.3","@types/mkdirp":"0.5.2","@types/mkdirp-promise":"5.0.0","@types/mri":"1.1.0","@types/ms":"0.7.30","@types/node":"11.11.0","@types/node-fetch":"2.1.4","@types/npm-package-arg":"6.1.0","@types/ora":"1.3.4","@types/pluralize":"0.0.29","@types/psl":"1.1.0","@types/strip-ansi":"3.0.0","@types/tar-fs":"1.16.1","@types/text-table":"0.2.0","@types/write-json-file":"2.2.1","@typescript-eslint/parser":"1.1.0","@zeit/dockerignore":"0.0.4","@zeit/fun":"0.6.0","@zeit/git-hooks":"0.1.4","@zeit/ncc":"0.17.4","@zeit/source-map-support":"0.6.2","alpha-sort":"2.0.1","ansi-escapes":"3.0.0","ansi-regex":"3.0.0","arg":"2.0.0","arr-flatten":"1.1.0","async-listen":"1.2.0","async-retry":"1.1.3","async-sema":"2.1.4","ava":"0.25.0","bytes":"3.0.0","cache-or-tmp-directory":"1.0.0","chalk":"2.3.1","clipboardy":"1.1.4","codecov":"3.1.0","credit-card":"3.0.1","date-fns":"1.29.0","death":"1.1.0","debug":"3.1.0","deployment-type":"1.0.1","docker-file-parser":"1.0.2","dotenv":"4.0.0","download":"6.2.5","email-prompt":"0.3.2","email-validator":"1.1.1","epipebomb":"1.0.0","eslint":"5.3.0","eslint-config-airbnb":"17.1.0","eslint-config-prettier":"3.3.0","eslint-import-resolver-typescript":"1.1.1","eslint-plugin-import":"2.14.0","eslint-plugin-jsx-a11y":"6.1.1","eslint-plugin-react":"7.11.0","eslint-plugin-typescript":"0.14.0","esm":"3.0.84","execa":"0.9.0","fetch-h2":"2.0.3","fs-extra":"7.0.1","glob":"7.1.2","http-proxy":"1.17.0","ini":"1.3.4","inquirer":"3.3.0","is-url":"1.2.2","jaro-winkler":"0.2.8","jsonlines":"0.1.1","load-json-file":"3.0.0","micro":"9.1.2","mime-types":"2.1.18","minimatch":"3.0.4","mkdirp":"0.5.1","mkdirp-promise":"5.0.1","mri":"1.1.0","ms":"2.1.1","node-fetch":"1.7.3","npm-package-arg":"6.1.0","nyc":"13.2.0","ora":"1.3.0","pcre-to-regexp":"0.0.5","pkg":"4.3.7","pluralize":"7.0.0","pre-commit":"1.2.2","prettier":"1.16.2","printf":"0.2.5","progress":"2.0.3","psl":"1.1.31","qr-image":"3.2.0","raw-body":"2.3.3","read-pkg":"2.0.0","semver":"5.5.0","serve-handler":"5.0.7","sinon":"4.4.2","strip-ansi":"4.0.0","stripe":"5.1.0","tar-fs":"1.16.3","test-listen":"1.1.0","text-table":"0.2.0","through2":"2.0.3","title":"3.4.1","tmp-promise":"1.0.3","ts-node":"7.0.1","typescript":"3.2.4","update-check":"1.5.3","utility-types":"2.1.0","which-promise":"1.0.0","write-json-file":"2.2.0","yarn":"1.13.0"}};
...
var parse = __webpack_require__(369);
var correct = __webpack_require__(754);
